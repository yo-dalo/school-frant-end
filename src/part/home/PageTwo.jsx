    ...
    <div className='w-full  overflow-hidden h-min-screen '>
      ...
      <div className="w-full h-[90vh]  py-9 bg-[linear-gradient(51deg,_#ECF0F1_57.12%,_#34495E_73.92%)] ">
        ...
        <div className="BT   gap-7 font-bold leading-tight  px-10">
          <h2 className='phone:none'>Welcome to Our College</h2>
        ...
        <div className="BT phone:pt-6 flex-1 md:gap-20 md:px-10 phone:flex-col-reverse phone:FC phone:nonea px-10 h-full">
          <div className=" text-3xl flex-1  md:text-2xl  phone:text-xl h-full center  leading-9 font-medium  ">
            <p>Our College provides quality education with modern classrooms, experienced teachers, and a student-focused learning environment. We aim to build strong values, discipline, and knowledge to prepare students for a bright future.</p>
          </div>
