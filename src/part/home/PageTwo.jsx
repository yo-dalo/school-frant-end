  ...
  return (
    <div className='w-screen  overflow-hidden h-min-screen '>
      <div className="w-full h-[90vh]  overflow-visible phone:uppercase  center flex-col leading-[100.1px] bg-[linear-gradient(235.34deg,_#ECF0F1_36.62%,_#34495E_78.39%)]">
        <h2 className='main-text  h-32 phone:text-6h-fitxl text-center w-full'>welcome</h2>
        <h2 className='main-text text-center h-32 phone:text-7xl w-full'>Yaduvanshi Degree </h2>
        <h2 className='main-text  text-center h-32 phone:text-8xl w-full'>College</h2>
