...
const PageEleven = () => {
  return (
    <div className="w-screen   overflow-hidden h-fit  center  ">
      ...
      <div className='w-screen BT md:gap-10 md:FC md:h-fit phone:h-screen phone:FC bg-main  h-[70vh]'>
        <div className="w-[45vw]  md:w-full phone:w-full  phone:gap-4  pl-3 pr-2 center gap-9 h-full ">
          ...
          <div className="FC phone:px-2 justify-center phone:h-full py-10 phone:py-0   phone:items-start items-end">
            ...
            <h1 className='text-[25vw] phone:text-[40vw] phone:translate-x-0 md:-translate-x-[100px]  phone:translate-y-0 -translate-x-[5rem] translate-y-[1rem]  relative  phone:leading-[1] leading-[0.5]'> <span className='text-2xl right-[28px] -top-[25px]  md:right-[2px]  phone:right-[2px] phone:top-[15px] px-0 text-red-600 absolute'>st</span>1  </h1>
