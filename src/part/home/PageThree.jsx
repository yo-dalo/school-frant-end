...
const PageThree = () => {
    return (
        <div className="w-full phone:py-8   md:py-8 bg-mainOne  phone:grid-cols-1 overflow-hidden grid grid-cols-3 px-20 phone:px-0  md:gap-5 md:px-2 gap-14 min-h-screen">
