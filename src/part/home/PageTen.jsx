...
const PageTen = () => {
  return (
    <div className="w-full none overflow-hidden min-h-screen flex flex-col items-center gap-6 sm:gap-8 px-4 sm:px-6 bg-[linear-gradient(180deg,_#34495E_0%,_#ECF0F1_100%)]">
