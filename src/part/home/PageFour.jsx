...
const PageFour = () => {
    return (
        ...
        <div className="w-full overflow-hidden  min-h-screen  bg-[linear-gradient(67.33deg,_#ECF0F1_67.96%,_#34495E_98.03%)] ">
            ...
            <h3 className="text-center phone:text-2xl  phone:text-left phone:leading-7 phone:px-3 px-10 text-3xl pb-28 leading-8 font-semibold ">Our college provides quality education with a focus on holistic development. Dedicated faculty, modern facilities, and innovative programs create an engaging environment that nurtures learning, creativity, and growth for every student.</h3>


            <div className="flex   gap-28 phone:gap-0 flex-col px-32 phone:px-3  ">

{[1,1,1].map((e,i)=>(

    
                    <div key={i} className=" w-full phone:FC phone:justify-start BT relativpx-72e  phone:relative  gap-10  phone:gap-5   border-t-4  border-black  phone:min-h-[150vw] h-40">
